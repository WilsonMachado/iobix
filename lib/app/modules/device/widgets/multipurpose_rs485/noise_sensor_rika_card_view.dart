...
class NoiseSensorRikaCardView extends StatelessWidget {
  @override
              ...
              Obx(() => DefaultCard(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Spacer(),
                        if (_.modelMultipurposeRS485.noiseSensorRikaStatus ==
                            BLE_GENERAL_CONSTANTS.STATUS_OK)
                          Column(
                            children: [
                              Text(
                                  _.modelMultipurposeRS485
                                      .noiseSensorRikaNoiseLevel,
