...
class NoiseSensorGemhoCardView extends StatelessWidget {
  @override
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Sensor de ruido (GEMHO)', style: miniTitle),
                            Row(
                              children: [
                        ...
                        Spacer(),
                        if (_.modelMultipurposeRS485.noiseSensorGemhoStatus ==
                        BLE_GENERAL_CONSTANTS.STATUS_OK)
                        Column(
                          children: [
                            Text(_.modelMultipurposeRS485.noiseSensorGemhoNoiseLevel, style: variableIndicator),
